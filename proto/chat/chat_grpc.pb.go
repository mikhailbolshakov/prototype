...
func (c *usersClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*CreateUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Users/CreateUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) GetUsersStatuses(ctx context.Context, in *GetUsersStatusesRequest, opts ...grpc.CallOption) (*GetUserStatusesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Users/GetUsersStatuses", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) DeleteUser(ctx context.Context, in *DeleteUserRequest, opts ...grpc.CallOption) (*DeleteUserResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Users/DeleteUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) SetStatus(ctx context.Context, in *SetStatusRequest, opts ...grpc.CallOption) (*SetStatusResponse, error) {
	out := new(SetStatusResponse)
	err := c.cc.Invoke(ctx, "/chat.Users/SetStatus", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) Login(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Users/Login", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *usersClient) Logout(ctx context.Context, in *LogoutRequest, opts ...grpc.CallOption) (*LogoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Users/Logout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUsersServer) SetStatus(context.Context, *SetStatusRequest) (*SetStatusResponse, error) {
...
func _Users_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Users/CreateUser",
	}
...
func _Users_GetUsersStatuses_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Users/GetUsersStatuses",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Users_DeleteUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Users/DeleteUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Users_SetStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Users/SetStatus",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *channelsClient) CreateClientChannel(ctx context.Context, in *CreateClientChannelRequest, opts ...grpc.CallOption) (*CreateClientChannelResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Channels/CreateClientChannel", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelsClient) GetChannelsForUserAndMembers(ctx context.Context, in *GetChannelsForUserAndMembersRequest, opts ...grpc.CallOption) (*GetChannelsForUserAndMembersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Channels/GetChannelsForUserAndMembers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *channelsClient) Subscribe(ctx context.Context, in *SubscribeRequest, opts ...grpc.CallOption) (*SubscribeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/chat.Channels/Subscribe", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Channels_CreateClientChannel_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Channels/CreateClientChannel",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Channels_GetChannelsForUserAndMembers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Channels/GetChannelsForUserAndMembers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Channels_Subscribe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Channels/Subscribe",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func (c *postsClient) AskBot(ctx context.Context, in *AskBotRequest, opts ...grpc.CallOption) (*AskBotResponse, error) {
	out := new(AskBotResponse)
	err := c.cc.Invoke(ctx, "/chat.Posts/AskBot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Posts_AskBot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AskBotRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PostsServer).AskBot(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat.Posts/AskBot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PostsServer).AskBot(ctx, req.(*AskBotRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _Posts_serviceDesc = grpc.ServiceDesc{
	ServiceName: "chat.Posts",
